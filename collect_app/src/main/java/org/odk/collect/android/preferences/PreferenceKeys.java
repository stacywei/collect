...
public final class PreferenceKeys {
    ...
    /**
     * Whether any existing username and email values have been migrated to form
     * metadata
     */
    ...
    private static HashMap<String, Object> getHashMap() {
        ...
        hashMap.put(KEY_SUBMISSION_TRANSPORT_TYPE,
                Collect.getInstance().getString(R.string.transport_type_value_internet));
        // user_interface_preferences.xml
    ...
    static final Collection<String> KEYS_WE_SHOULD_NOT_RESET = Arrays.asList(KEY_LAST_VERSION, KEY_FIRST_RUN,
            KEY_METADATA_MIGRATED, KEY_AUTOSEND_WIFI, KEY_AUTOSEND_NETWORK, ACTIVITY_LOGGER_ANALYTICS);
